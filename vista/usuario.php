    ...
    <table class="table table-bordered table-hover w-100" id="example">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><?= $datos->usuario ?></td>
                <td>
                    <a href="" data-bs-toggle="modal" data-toggle="modal" data-target="#exampleModal<?= $datos->id_usuario ?>" class="btn btn-warning"><i class="fas fa-pen"></i></a>
                    <a href="usuario.php?id=<?= $datos->id_usuario ?>" onclick="advertencia(event)" class="btn btn-danger"><i class="fas fa-trash"></i></i></a>
                </td>
            </tr>
